          ...
          <div className="bg-white rounded-xl shadow-sm border p-12" style={{ borderColor: '#E2E8F0' }}>
            ...
            <div className="border-t pt-6" style={{ borderColor: '#E2E8F0' }}>
              ...
              <button
                ...
                className="w-full mb-3 px-4 py-3 rounded-lg font-medium transition-all flex items-center justify-center gap-2"
                style={{
                  backgroundColor: linkCopied ? '#DCFCE7' : '#F1F5F9',
                  color: linkCopied ? '#16A34A' : '#1E293B'
                }}
                onMouseEnter={(e) => {
                  if (!linkCopied) e.target.style.backgroundColor = '#E2E8F0'
                }}
                onMouseLeave={(e) => {
                  if (!linkCopied) e.target.style.backgroundColor = '#F1F5F9'
                }}
              >
                {linkCopied ? (
                  <>
